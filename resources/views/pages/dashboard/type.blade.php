    ...
    <div>
        ...
        <button @click='$dispatch("add")' type="button"
            class="inline-flex items-center justify-center w-full px-4 py-2 my-4 text-base font-medium text-center text-red-700 bg-red-100 border border-transparent rounded-md md:w-auto hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-red-500"><i
                class="fa-solid fa-plus"></i> &nbsp; Tambah Jenis Laporan</button>
                            ...
                            <div class="flex items-center justify-between w-full p-6 space-x-6">
                                <div class="flex-1 truncate">
                                    <div class="flex items-center space-x-3">
                                        <h3 class="font-medium text-gray-900 truncate">Nama Jenis Laporan</h3>
                                    </div>
                                    <p class="mt-1 text-gray-500 capitalize truncate">{{ $type->name }}</p>
                                </div>
                                <img class="h-12" src="{{ asset('icons/megaphone-alt.svg') }}">
                            </div>
                            <div class="bg-gray-100 rounded-b-lg">
                                <div class="flex -mt-px divide-x divide-gray-200">
                                    <div class="flex flex-1 w-0" @click='$dispatch("edit", @json($type))'>
                                        <a href="#"
                                    ...
                                    <div class="flex flex-1 w-0 -ml-px"
                                        @click='$dispatch("delete", @json($type))'>
                                        <a href="#"
        ...
        <div x-show="open" class="fixed inset-0 z-10 overflow-y-auto">
            <div class="flex items-end justify-center min-h-full p-4 text-center sm:items-center sm:p-0">
                <div x-show="open" x-transition:enter="ease-out duration-300"
                    ...
                    <form class="mb-0" action="/type/add" method="POST">
                        @csrf

                        <div>
                            <h3 class="mb-4 text-lg font-medium leading-6 text-center text-gray-900">Tambah Jenis Laporan
                            </h3>

                            <div>
                                <label class="block text-sm font-medium text-gray-700">Nama Jenis Laporan</label>
        ...
        <div x-show="open" class="fixed inset-0 z-10 overflow-y-auto">
            <div class="flex items-end justify-center min-h-full p-4 text-center sm:items-center sm:p-0">
                <div x-show="open" x-transition:enter="ease-out duration-300"
                    ...
                    <form class="mb-0" action="/type/update" method="POST">
                        @csrf

                        <div>
                            <h3 class="mb-4 text-lg font-medium leading-6 text-center text-gray-900">Ubah Jenis Laporan
                            </h3>
                            ...
                            <template x-if="data">
                                <div>
                                    ...
                                    <div class="flex mt-1 rounded-md shadow-sm">
                                        ...
                                        <input x-model="data.name" name="type" type="text"
                                            class="flex-1 block w-full min-w-0 px-3 py-2 border-gray-300 rounded-none rounded-r-md focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                    </div>
                                </div>
                            </template>
            ...
            <div class="flex items-end justify-center min-h-full p-4 text-center sm:items-center sm:p-0">
                <div x-show="open" x-transition:enter="ease-out duration-300"
                    ...
                    <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                <h3 class="text-lg font-medium leading-6 text-gray-900" id="modal-title">Hapus Jenis Laporan
                                </h3>
                                <div class="mt-2">
                                    <template x-if="data">
                                        <p class="text-sm text-gray-500">Apakah anda yakin ingin menghapus jenis laporan "<span
                    ...
                    <div class="px-4 py-3 bg-gray-100 sm:flex sm:flex-row-reverse sm:px-6">
                        <template x-if="data">
                            <a x-bind:href="'/type/delete/' + data.uuid" href="#">
                                <button type="button"
