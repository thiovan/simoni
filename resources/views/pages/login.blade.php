...
@section('content')
    ...
    <div class="flex flex-col items-center h-full p-16 bg-no-repeat bg-cover bg-default">
        ...
        <form class="w-1/4" action="/auth" method="POST">
            @if ($errors->any())
            ...
            <div class="mb-6">
                <input type="text" name="username"
                    class="w-full rounded-lg py-2.5 text-2xl placeholder:font-century-gothic font-bold placeholder:uppercase text-center"
            ...
            <button
                class="inline-flex items-center justify-between w-full p-5 mt-8 text-2xl text-white bg-red-700 rounded-full font-century-gothic bg-gradient-to-t from-red-900 to-red-500 outline-double -outline-offset-4 outline-1 outline-white">
